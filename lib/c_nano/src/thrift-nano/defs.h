...
#define THRIFT_TRANSPORT_ARDUINO_SERIAL_DEF 0
...
#endif
#ifndef THRIFT_TRANSPORT_ARDUINO_SERIAL
#define THRIFT_TRANSPORT_ARDUINO_SERIAL THRIFT_TRANSPORT_ARDUINO_SERIAL_DEF
#endif
